...
class LocalizationMetrics:
    ...
    def calculate(
        ...
        metrics = {
            ...
            "function_top3": False,
            "span_overlap": 0.0,
            "lines_exposed_to_patcher": sum(max(0, span.end_line - span.start_line + 1) for span in result.spans),
